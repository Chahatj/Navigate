...
/** Traversing all legs */
                for(int j=0;j<jLegs.length();j++){
                    ...
                    start = (String) jLegs.getJSONObject(j).get("start_address");

                    Log.i("start",start);

                    end = (String) jLegs.getJSONObject(j).get("end_address");

                    Log.i("end",end);

                    String starttoend = start+"\n"+"TO"+"\n"+end;
